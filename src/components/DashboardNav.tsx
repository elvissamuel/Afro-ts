            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="hidden lg:ml-4 lg:block">
                <div className="flex items-center gap-2">
                  ...
                  <div className='text-primaryColor text-sm p-1 font-semibold flex-shrink-0 '><Link href={'/signup'}><button className='rounded px-2 py-1 bg-secondaryColor'>Sign up</button></Link></div>}
                </div>
              </div>
            </div>
          </div>
